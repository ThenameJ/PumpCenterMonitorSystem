/**
* @FileName             alarmvoicepage.cpp
* @Brief
* @Version              1.0.0
* @Current Maintainter
* @Update Date          2021-11-09 10:13:38
* @Author               zhoumingjie
* @email
* @Create Date          2021-11-09 10:13:38
* @
*/
...
AlarmVoicePage::AlarmVoicePage(QWidget *parent) : QWidget(parent)
{
    windowInit();
}

AlarmVoicePage::~AlarmVoicePage()
{


}

void AlarmVoicePage::windowInit()
{
    vlayout = new QVBoxLayout;
    hlayout = new QHBoxLayout;
    titleLayout = new QHBoxLayout;
    voiceLabel = new QLabel(tr("报警声音开关："));
    titleLabel = new QLabel(tr("报警配置"));

    button = new SwitchButton();
    button->setButtonStyle(SwitchButton::ButtonStyle_Rect);
    button->setChecked(uimanager->m_voiceCheck);
...
SwitchButton::SwitchButton(QWidget *parent): QWidget(parent)
{
    ...
    connect(this,SIGNAL(checkedChanged(bool)),uimanager,SIGNAL(voiceCheckChanged(bool)));
